<template>
    ...
    <el-col :span="24" class="mb20">
      <el-form-item :label="t('topic.title')" prop="title">
        <el-input v-model="form.title" :placeholder="t('topic.inputTitleTip')"/>
      </el-form-item>
      </el-col>
...
<script setup lang="ts" name="GptTopicDialog">
import { useDict } from '/@/hooks/dict';
import { useMessage } from "/@/hooks/message";
import { getObj, addObj, putObj } from '/@/api/bridge/topic'
...
// 初始化表单数据
const getgptTopicData = (id: string) => {
  // 获取数据
  loading.value = true
